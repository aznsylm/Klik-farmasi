                    ...
                    <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="article_type" name="article_type" required>
                                    ...
                                    <option value="kehamilan" {{ old('article_type') == 'kehamilan' ? 'selected' : '' }}>
                                        Hipertensi Kehamilan</option>
                                    <option value="non-kehamilan"
                                        {{ old('article_type') == 'non-kehamilan' ? 'selected' : '' }}>Hipertensi
                        ...
                        <div class="form-group">
                            <label for="content" class="font-weight-bold">Narasi Lengkap<span
                                    class="text-danger">*</span></label>
                            <x-ckeditor id="content" name="content" :value="old('content')" config="full" :required="true" />
                        </div>
