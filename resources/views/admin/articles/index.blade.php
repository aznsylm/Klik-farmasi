                        ...
                        <tbody>
                            @forelse ($articles as $article)
                                <tr>
                                    ...
                                    <td>
                                        @if ($article->image)
                                            <img src="{{ asset('storage/' . $article->image) }}" alt="{{ $article->title }}" class="img-thumbnail" style="max-width: 60px; max-height: 60px; object-fit: cover;">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        @if($article->views > 0)
                                            <button class="btn btn-sm btn-info ml-2" data-toggle="modal" data-target="#readersModal{{ $article->id }}">
                                                Detail
                                            </button>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.artikel.edit', $article->id) }}" class="btn btn-warning btn-sm" title="Edit">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">Belum ada yang membaca</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
