        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12 col-md-4 mb-2 mb-md-0">
                    <button type="button" class="btn btn-primary w-100 w-md-auto" data-toggle="modal"
                        data-target="#tambahPasienModal">
                    ...
                    <form method="GET" action="{{ route('admin.pasien') }}">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari nama, email, HP, jenis kelamin, usia..." value="{{ request('search') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('admin.pasienDetail', $user->id) }}"
