            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Usia</label>
                            <input type="number" class="form-control" name="usia" id="editUserAge" 
                                min="1" max="120" 
                                title="Usia antara 1-120 tahun"
                                required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-primary" onclick="togglePassword('editPasswordInput')">
