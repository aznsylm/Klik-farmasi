    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-4 mb-md-0">
                <img src="{{ url('assets/LOGO KLIKFARMASI VEKTOR MIRING.png') }}" alt="Logo Farmasi Universitas Alma Ata"
                    class="footer-logo" width="220" height="auto" loading="lazy" decoding="async"
                    onload="console.log('Logo loaded successfully')"
                    onerror="console.log('Logo failed to load:', this.src); this.src='{{ url('assets/Favicon.png') }}'; this.style.width='60px'; this.style.height='60px';">
                ...
                <div class="footer-social">
                    ...
                    <a href="https://www.instagram.com/klikfarmasi.official/" class="footer-social-icon"
                        target="_blank">
            ...
            <div class="col-md-3">
                ...
                <div class="footer-map ratio ratio-4x3">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.913!2d110.321932!3d-7.818442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7af7e2b2acea97%3A0xa3cb91d3e65407b2!2sUniversitas%20Alma%20Ata%20Yogyakarta!5e1!3m2!1sid!2sid"
                        width="300" height="225" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade" title="Lokasi Universitas Alma Ata"></iframe>
                </div>
            </div>
        </div>
        ...
        <div class="row footer-bottom">
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="footer-partners">
                    <p>Bagian dari:</p>
                    <img src="{{ asset('assets/Farmasi-LogoUAA_white.png') }}" alt="Logo Farmasi" loading="lazy"
                        decoding="async">
                </div>
            </div>
