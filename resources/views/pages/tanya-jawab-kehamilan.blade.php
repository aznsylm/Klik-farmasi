...
@section('title', 'Tanya Jawab - Hipertensi Kehamilan')
    ...
    <section class="py-5 faq-section">
        <div class="container px-4">
            ...
            <div class="text-center mb-5">
                <h2 class="fw-bolder mb-3" style="color: #0b5e91;">Hipertensi Kehamilan</h2>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="faq-group mb-5" id="hipertensi-kehamilan">
                        <div class="faq-group-header">
                            ...
                            <p class="text-muted">Informasi tentang hipertensi yang terjadi selama kehamilan</p>
                        </div>
                        <div class="accordion custom-accordion" id="accordionHipertensiKehamilan">
                            @foreach ($faqs as $faq)
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse {{ $loop->first ? 'show' : '' }}" id="collapse{{ $loop->index }}" aria-labelledby="heading{{ $loop->index }}" data-bs-parent="#accordionHipertensiKehamilan">
                    ...
                    <div class="sticky-top" style="top: 2rem; z-index: 1000;">
                        ...
                        <div class="card border-0 rounded-4 shadow-sm mb-4">
                            ...
                            <div class="card-body p-4">
                                <p class="card-text">Temukan jawaban cepat untuk pertanyaan tentang hipertensi kehamilan.</p>
                                <div class="quick-links">
                                    <a href="{{ route('tanya-jawab.non-kehamilan') }}" class="quick-link">
                                        <i class="bi bi-heart-pulse"></i>
                                        <span>Hipertensi Non-Kehamilan</span>
                                    </a>
                                    <a href="#hipertensi-kehamilan" class="quick-link">
                                        <i class="bi bi-person-hearts"></i>
                                        <span>Hipertensi saat hamil</span>
                                    </a>
                                </div>
                            </div>
                        </div>
