...
@section('title', 'Tanya Jawab - Hipertensi Non-Kehamilan')
    ...
    <section class="py-5 faq-section">
        <div class="container px-4">
            ...
            <div class="text-center mb-5">
                <h2 class="fw-bolder mb-3" style="color: #0b5e91;">Hipertensi Non-Kehamilan</h2>
                        ...
                        <div class="accordion custom-accordion" id="accordionHipertensiNonKehamilan">
                            @foreach ($faqs as $faq)
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-collapse collapse {{ $loop->first ? 'show' : '' }}" id="collapse{{ $loop->index }}" aria-labelledby="heading{{ $loop->index }}" data-bs-parent="#accordionHipertensiNonKehamilan">
                    ...
                    <div class="sticky-top" style="top: 2rem; z-index: 1000;">
                        ...
                        <div class="card border-0 rounded-4 shadow-sm mb-4">
                            ...
                            <div class="card-body p-4">
                                <p class="card-text">Temukan jawaban cepat untuk pertanyaan tentang hipertensi non-kehamilan.</p>
                                <div class="quick-links">
                                    <a href="{{ route('tanya-jawab.kehamilan') }}" class="quick-link">
                                        <i class="bi bi-person-hearts"></i>
                                        <span>Hipertensi Kehamilan</span>
                                    </a>
                                    <a href="#hipertensi-non-kehamilan" class="quick-link">
                                        <i class="bi bi-heart-pulse"></i>
                                        <span>Hipertensi umum</span>
                                    </a>
                                </div>
                            </div>
                        </div>
