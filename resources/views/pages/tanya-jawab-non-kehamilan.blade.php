...
@push('head')
    <!-- SEO Meta Tags -->
    <meta name="description" content="FAQ dan tanya jawab seputar hipertensi umum. Dapatkan jawaban dari ahli farmasi tentang obat hipertensi, gaya hidup sehat, dan tips pengelolaan tekanan darah tinggi.">
    <meta name="keywords" content="FAQ hipertensi, tanya jawab tekanan darah tinggi, obat hipertensi, konsultasi farmasi, tips kesehatan">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="faq-search mb-5">
                        <div class="input-group"><span class="input-group-text bg-white border-end-0"><i
                                ...
                                class="form-control border-start-0" placeholder="Cari pertanyaan..." aria-label="Cari pertanyaan tentang hipertensi"></div>
                    </div>
                        ...
                        <div class="accordion custom-accordion" id="accordionHipertensiNonKehamilan">
                            @foreach ($faqs as $faq)
                                <div class="accordion-item">
                                    <h3 class="accordion-header" id="heading{{ $loop->index }}"><button
