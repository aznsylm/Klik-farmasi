        ...
        <div class="container-fluid">
            ...
            @php
                ...
                $daysSinceLastInput = $latestTekananDarah
                    ? (int) \Carbon\Carbon::parse($latestTekananDarah->created_at)->diffInDays(now())
                    : 999;
                ...
                if (!$latestTekananDarah) {
                    ...
                    $alertMessage =
                        'Sudah ' .
                        $daysSinceLastInput .
                        ' hari tidak input tekanan darah. Yuk catat tekanan darah Anda!';
                    ...
                    <div class="col-12">
                        <div class="alert {{ $alertClass }} alert-dismissible">
                            ...
                            @if (!$latestPengingat && !$latestTekananDarah)
                                <br><a href="{{ route('pasien.obat') }}" class="btn btn-sm mt-2">
                                    Isi Pengingat Obat
                                </a>
                            @endif
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('pasien.tekanan-darah') }}" class="small-box-footer">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        <a href="{{ route('pasien.obat') }}" class="small-box-footer">
                            Lihat Detail <i class="fas fa-arrow-circle-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{ $latestTekananDarah ? $latestTekananDarah->sistol . '/' . $latestTekananDarah->diastol : '-' }}
                            </h3>
                            <p>TD Terakhir</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="{{ route('pasien.konsultasi') }}" class="small-box-footer">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <a href="{{ route('pasien.tekanan-darah') }}" class="btn btn-primary btn-block">
                                        <i class="fas fa-plus mr-1"></i> Catat TD
                                    </a>
                                </div>
                                <div class="col-6 mb-3">
                                    <a href="{{ route('pasien.obat') }}" class="btn btn-success btn-block">
                                        <i class="fas fa-pills mr-1"></i> Lihat Obat
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('pasien.konsultasi') }}" class="btn btn-warning btn-block">
                                        <i class="fas fa-comments mr-1"></i> Konsultasi
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('pasien.tekanan-darah.pdf') }}" class="btn btn-danger btn-block">
