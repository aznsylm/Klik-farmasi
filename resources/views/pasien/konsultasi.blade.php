            ...
            <div class="row">
                <div class="col-12">
                    <div class="card bg-gradient-success">
                        <div class="card-body">
                            <h4 class="text-white mb-1"><i class="fas fa-comments mr-2"></i> Butuh Bantuan? Konsultasi
                                Sekarang!</h4>
                            <p class="text-white mb-0">Punya pertanyaan tentang obat atau kesehatan? Jangan ragu untuk
                                menghubungi tim ahli kami melalui nomor yang tersedia di bawah ini.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="card card-widget widget-user">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <a href="https://wa.me/+6281902808231" class="btn btn-primary btn-block"
                                        target="_blank">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="card card-widget widget-user">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <a href="https://wa.me/+6281292936247" class="btn btn-success btn-block"
                                        target="_blank">
                                        <i class="fab fa-whatsapp mr-1"></i> Chat WhatsApp
                                    </a>
                                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="card card-widget widget-user">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <a href="https://wa.me/+6281271954082" class="btn btn-warning btn-block"
                                        target="_blank">
                                        <i class="fab fa-whatsapp mr-1"></i> Chat WhatsApp
                                    </a>
                                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="card card-widget widget-user">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <a href="https://wa.me/+6282286438701" class="btn btn-danger btn-block"
                                        target="_blank">
                                        <i class="fab fa-whatsapp mr-1"></i> Chat WhatsApp
                                    </a>
                                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-question-circle mr-1"></i> Pertanyaan yang Sering
                                Diajukan</h3>
                        </div>
                        <div class="card-body">
                            <div class="accordion" id="faqAccordion">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left" type="button"
                                                ...
                                                <i class="fas fa-chevron-down mr-2"></i> Kapan saya bisa menghubungi tim
                                                farmasi?
                                            </button>
                                        </h2>
                                    </div>
                                    <div id="faq1" class="collapse" data-parent="#faqAccordion">
                                        <div class="card-body">
                                            Anda dapat menghubungi tim farmasi kami kapan saja melalui WhatsApp untuk
                                    ...
                                    <div class="card-header">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                ...
                                                <i class="fas fa-chevron-down mr-2"></i> Apa saja yang bisa
                                                dikonsultasikan?
                                            </button>
                                        </h2>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                ...
                                                <i class="fas fa-chevron-down mr-2"></i> Berapa lama tim farmasi membalas
                                                pesan?
                                            </button>
                                        </h2>
                                    </div>
                                    <div id="faq4" class="collapse" data-parent="#faqAccordion">
                                        <div class="card-body">
                                            Tim farmasi kami berusaha membalas pesan Anda sesegera mungkin, biasanya dalam
                                            waktu beberapa menit hingga 1 jam.
                                        </div>
                                    </div>
                                </div>
                            </div>
