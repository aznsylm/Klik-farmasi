                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            {{ Auth::user()->puskesmas === 'godean_2' ? 'Daftar Suplemen' : 'Daftar Obat' }}</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card bg-gradient-info">
                            <div class="card-body">
                                <h4 class="text-white mb-1">
                                    {{ Auth::user()->puskesmas === 'godean_2' ? 'Pengingat Suplemen Anda' : 'Pengingat Obat Anda' }}
                                </h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-warning">
                                ...
                                <strong>Perhatian!</strong> Pengingat obat sedang tidak aktif karena semua obat berstatus
                                habis. Ubah status obat menjadi aktif untuk mengaktifkan kembali pengingat.
                            </div>
                        </div>
                    </div>
                @endif
                            ...
                            <div class="card {{ $obat->status_obat === 'aktif' ? 'card-success' : 'card-secondary' }}">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        {{ Auth::user()->puskesmas === 'godean_2' ? 'Suplemen' : 'Obat' }}
                                        {{ $index + 1 }}
                                    </h3>
                                </div>
                                <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    {{ Auth::user()->puskesmas === 'godean_2' ? 'Ringkasan Suplemen' : 'Ringkasan Obat' }}
                                </h3>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h4 class="text-muted">
                                    {{ Auth::user()->puskesmas === 'godean_2' ? 'Belum Ada Suplemen' : 'Belum Ada Obat' }}
                                </h4>
                                <p class="text-muted">
                                    {{ Auth::user()->puskesmas === 'godean_2' ? 'Anda belum memiliki pengingat suplemen.' : 'Anda belum memiliki pengingat obat.' }}
                                </p>
