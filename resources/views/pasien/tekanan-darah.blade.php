                        ...
                        <div class="card-body">
                            <form id="bloodPressureForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="sistol" min="70" max="250"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label>Diastol (mmHg)</label>
                                    <input type="number" class="form-control" id="diastol" min="40" max="150"
                                        required>
                                </div>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            if ($record->sistol < 120 && $record->diastol < 80) {
                                                                ...
                                                                ($record->sistol >= 130 && $record->sistol <= 139) ||
                                                                ($record->diastol >= 80 && $record->diastol <= 89)
                                                            ) {
                                                        ...
                                                        @if (isset($customStyle))
                                                            <strong
                                                                style="{{ $customStyle }}">{{ $category }}</strong>
                                                        @else
                                                            <strong
                                                                class="{{ $textColor }}">{{ $category }}</strong>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-warning btn-sm"
                                                            onclick="editRecord({{ $record->id }}, {{ $record->sistol }}, {{ $record->diastol }})"
                                                            title="Edit">
            ...
            <div class="modal-content">
                ...
                <form id="editForm">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Sistol (mmHg)</label>
                            <input type="number" class="form-control" id="editSistol" min="70" max="250"
                                required>
                        </div>
                        <div class="form-group">
                            <label>Diastol (mmHg)</label>
                            <input type="number" class="form-control" id="editDiastol" min="40" max="150"
                                required>
                        </div>
                    </div>
