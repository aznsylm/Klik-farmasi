                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select {{ $errors->has('puskesmas') ? 'is-invalid' : '' }}"
                                        ...
                                        <option value="kalasan" {{ old('puskesmas', $user->puskesmas) == 'kalasan' ? 'selected' : '' }}>Puskesmas Kalasan</option>
                                        <option value="godean_2" {{ old('puskesmas', $user->puskesmas) == 'godean_2' ? 'selected' : '' }}>Puskesmas Godean 2</option>
                                        <option value="umbulharjo" {{ old('puskesmas', $user->puskesmas) == 'umbulharjo' ? 'selected' : '' }}>Puskesmas Umbulharjo</option>
                                    </select>
                                    @error('puskesmas')
                                        <div class="error-message">{{ $message }}</div>
                                    @enderror
